...
INSERT INTO Album (albumid, title, created , lastupdated, username) VALUES
(1, 'I love sports', NOW(), NOW(), 'sportslover'),
(2, 'I love football', NOW(), NOW(), 'sportslover'),
(3, 'Around The World', NOW(), NOW(), 'traveler'),
(4, 'Cool Space Shots', NOW(), NOW(), 'spacejunkie');
