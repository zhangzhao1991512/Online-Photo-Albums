...
PORT1=6600												# TODO set your ports here!
#PORT2=XXXX

# GROUP VARIABLES
GROUP=group105											# TODO set you group number
SECRET=bowenjackminzhe										# TODO set your secret
...
PROJECT=db												# TODO project number here (for sql)
...
gunicorn -b  $SERVER:$PORT1 -w 2 -D --debug --access-logfile access.log --error-logfile error.log app:app
echo "Done."
